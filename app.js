...
function App() {
  ...
  }, "Finance"), canEdit && /*#__PURE__*/React.createElement("button", {
    className: "btn",
    onClick: () => {
      setForm({
        member: "",
  ...
  }, "No tasks"))))), view === "members" && /*#__PURE__*/React.createElement(MembersView, {
    members: members,
    tasks: tasks,
    canManage: canManage,
    onReload: reloadMembers
  }), view === "logs" && canManage && /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      justifyContent: "space-between",
      alignItems: "center",
